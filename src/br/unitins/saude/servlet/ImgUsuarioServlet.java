package br.unitins.saude.servlet;
...
public class ImgUsuarioServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -415035308616399775L;

	/**
     * 
     * @param request - recebe o parametro nome (nome da imagem do usuario)
